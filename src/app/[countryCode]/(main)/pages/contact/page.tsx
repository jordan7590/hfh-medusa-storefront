  ...
  return (
    <>
      <div className="header-image__container___xmXph">
        ...
        <div className="header-image__image___hv4HR contact__newHeaderImage___vysSP" 
        style={{backgroundImage:"url(https://static.swag.com/images-webpack/contact-header-image.6f53df4b5e364590b035..jpg) !important;"}}>
        </div>
      </div>
      ...
      <div className="contact__formSection___v7QQA" style={{backgroundImage:"url(https://static.swag.com/images-webpack/contact-bg-pc-2.9f34a33ff461b714568a..svg);"}}>
